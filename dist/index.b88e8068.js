...
})({"KDQek":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "4da7f2c0b88e8068";
"use strict";
...
},{}],"bmrE7":[function(require,module,exports) {
...
const controlRecipes = async function() {
    try {
        ...
        if (!id) return;
        // load
        await _model.loadRecipeData(id);
...
const controlSearchResults = async function() {
    try {
        // get query
        const query = (0, _view.viewer).getQuery();
        // load search results
...
const init = function() {
    ...
    (0, _view.viewer).addHandlerPage(controlPageBtn);
    (0, _view.viewer).addHandlerServings(controlServings);
    (0, _view.viewer).addHandlerBookmarkBtn(controlBookmarkBtn);
    (0, _view.viewer).addHandlerBookmarkList(controlBookmarkList);
    (0, _view.viewer).addHandlerShowWindow();
    (0, _view.viewer).addHandlerHideWindow();
    (0, _view.viewer).addHandlerUpload(controlUploadRecipe);
};
init();
...
},{}],"3TEvl":[function(require,module,exports) {
...
const loadRecipeData = async function(id) {
    try {
        const response = await Promise.race([
            fetch(`${(0, _configJs.API_URL)}/${id}?key=${(0, _configJs.KEY)}`),
            (0, _helpersJs.timeout)((0, _configJs.TIMEOUT_SEC))
        ]);
        const data = await response.json();
        if (!response.ok) throw new Error("No recipes found for your query. Please try again!");
        console.log(data);
...
const loadSearchResults = async function(query) {
    try {
        const response = await Promise.race([
            fetch(`${(0, _configJs.API_URL)}?search=${query}&key=${(0, _configJs.KEY)}`),
            (0, _helpersJs.timeout)((0, _configJs.TIMEOUT_SEC))
        ]);
        const data = await response.json();
...
const getIngredients = function(recipe) {
    return Object.entries(recipe).filter((entry)=>entry[0].startsWith("ingredient") && entry[1] !== "").map((ing)=>{
...
const uploadRecipe = async function(newRecipe) {
    try {
        ...
        const response = await Promise.race([
            fetch(`${(0, _configJs.API_URL)}?key=${(0, _configJs.KEY)}`, {
                method: "POST",
                headers: {
...
const KEY = "3d42867b-5b9c-444b-a7f5-f6926ccbda14";
...
},{}],"g7MJX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8EKc9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class view {
    ...
    addHandlerShowWindow() {
        this.#btnAddRecipe.addEventListener("click", (function() {
            this.#window.classList.toggle("hidden");
            this.#overlay.classList.toggle("hidden");
        }).bind(this));
    }
    addHandlerHideWindow() {
        this.#btnCloseWindow.addEventListener("click", (function() {
            this.#window.classList.toggle("hidden");
            this.#overlay.classList.toggle("hidden");
        }).bind(this));
...
},{"url:../img/icons.svg":"c7gpy","./config":"eFaSl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c7gpy":[function(require,module,exports) {
...
},{}]},["KDQek","bmrE7"], "bmrE7", "parcelRequire3a11")

//# sourceMappingURL=index.b88e8068.js.map
